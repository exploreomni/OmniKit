...
export const OMNI_API_CONTRACTS: OmniApiContract[] = [
  ...
  { id: 'document-labels-bulk', path: '/api/v1/documents/:param/labels', methods: ['PATCH'], status: 'documented_current', workflows: ['dashboard_migrator', 'label_manager'], docsUrl: 'https://docs.omni.co/api/document-labels/bulk-update-document-labels', probeMode: 'controlled_write' },
  ...
  { id: 'folder-labels-bulk', path: '/api/v1/folders/:param/labels', methods: ['PATCH'], status: 'documented_current', workflows: ['label_manager'], docsUrl: 'https://docs.omni.co/api/folder-labels/bulk-update-folder-labels', probeMode: 'controlled_write' },
